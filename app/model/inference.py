...
audio_weights = Path("app/models/weights/audio/finetuned_Full-RESNET_model.pt")
lyrics_weights = Path("app/models/weights/lyrics/finetuned_BERT_model-epoch-v.3.pt")
